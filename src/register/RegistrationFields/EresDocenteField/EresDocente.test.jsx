...
import { EresDocente } from '../index';

const IntlEresDocente = injectIntl(EresDocente);

describe('EresDocenteTest', () => {
  let value = false;
  ...
  it('should render error msg if Terms of Service checkbox is not checked', () => {
    ...
    const { container } = render(
      <IntlProvider locale="en">
        <IntlEresDocente errorMessage={errorMessage} onChangeHandler={changeHandler} />
      </IntlProvider>,
    );
  ...
  it('should render Terms of Service field', () => {
    const { container } = render(
      <IntlProvider locale="en">
        <IntlEresDocente onChangeHandler={changeHandler} />
      </IntlProvider>,
    );
