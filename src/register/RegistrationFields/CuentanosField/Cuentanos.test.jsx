...
import { Cuentanos } from '../index';

const IntlCuentanos = injectIntl(Cuentanos);

describe('CuentanosTest', () => {
  let value = "Me interesa  mucho";
  ...
  it('should render error msg if Terms of Service checkbox is not checked', () => {
    ...
    const { container } = render(
      <IntlProvider locale="en">
        <IntlCuentanos errorMessage={errorMessage} onChangeHandler={changeHandler} />
      </IntlProvider>,
    );
  ...
  it('should render Terms of Service field', () => {
    const { container } = render(
      <IntlProvider locale="en">
        <IntlCuentanos onChangeHandler={changeHandler} />
      </IntlProvider>,
    );
