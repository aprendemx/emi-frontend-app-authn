...
const RegistrationPage = (props) => {
  ...
  const [formFields, setFormFields] = useState({
    ...
    grade: '',
    curp: '',
    honorCode: false,      // Nuevo: checkbox código de honor
    privacyPolicy: false,  // Nuevo: checkbox aviso de privacidad
  });
  ...
  // Handlers específicos para checkboxes de términos
  const handleHonorCodeChange = (event) => {
    ...
    // Limpiar error si se marca
    if (isChecked && errors.honorCode) {
  ...
  const handlePrivacyPolicyChange = (event) => {
    ...
    // Limpiar error si se marca
    if (isChecked && errors.privacyPolicy) {
      setErrors(prevErrors => ({
        ...prevErrors,
        privacyPolicy: '',
      }));
        ...
        {autoSubmitRegForm && !errorCode.type ? (
          ...
          >
            ...
            <Form id="registration-form" name="registration-form">
              ...
              <TermsAndPrivacy
                honorCode={formFields.honorCode}
                privacyPolicy={formFields.privacyPolicy}
                onHonorCodeChange={handleHonorCodeChange}
                onPrivacyPolicyChange={handlePrivacyPolicyChange}
                honorCodeError={errors.honorCode}
                privacyPolicyError={errors.privacyPolicy}
              />
